...
///////////////////////////////////////////
{
  ...
  r1 = (Y[n+k] - Y[n] - a);
  r2 = (Y[n] - Y[n-k] - a);   
  F_1 = Alpha*(r1*r1 - r2*r2) + bet*(r1*r1*r1 - r2*r2*r2);
  ...
  r2 = r1;
  r1 = (Y[n+k] - Y[n] - a);
  F_N = Alpha*(r1*r1 - r2*r2) + bet*(r1*r1*r1 - r2*r2*r2);
  ...
  ////////////////////////////////////
  //correzione per conservazione momento

  F_th = 0.5*(F_1 + F_N);

  R[k+dim] = R[k+dim] - F_th; 
  R[k*N+dim] = R[k*N+dim] - F_th; 
  ////////////////////////////////////
